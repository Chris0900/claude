...
PLAN = [
    ...
    ('베트남', 'vn', '1차목표: 오프라인 판매량 증대 + CGF GP 구축 | 내년 법인화 핵심국가 | 대표 3개월 1회 현지 직접 방문', [
        (' [하이하이] P-Max 연계 디지털 광고',       '계약 완료 / 키성장 타겟 / 쇼피 연동',
         [0,0,0,0,0,60,90,110,80,30,20,0]),
        (' CGF 의사협회 논문 제작',                  '논문 제작비 6,000만 (6월 착수) + 배포·알리기 2,000만',
         [0,0,0,0,0,60,20,0,0,0,0,0]),
        (' 오프라인 시음 (롯데/이마트/윈마트 40개점)', '윈마트 15개점 포함 / 월 2,500만 / 6~9월 집중',
         [0,0,0,0,0,25,25,25,25,0,0,0]),
        (' 이너샵 대체 — 쇼피Ads + Zalo 타겟광고',  '이너샵 VMD 대체 / 8월 오픈 연동 / 반경 3km 지오타겟',
         [0,0,0,0,0,0,0,15,10,0,0,0]),
        (' 매장 샘플링 + 온라인 콘텐츠 연계',        '시음→SNS 후기→재구매 루프 / 일본 칼비 구조 복사',
         [0,0,0,0,0,0,10,15,10,0,0,0]),
        (' 라이브커머스 확산 광고',                  '쇼피 라이브 + TikTok Live 연동 / 전환 극대화',
         [0,0,0,0,0,0,10,10,0,0,0,0]),
    ]),
    ('일본', 'jp', '최종목표: 코스트코 데모 행사 효율 향상 + 뉴케어 지속 운영 | 6/5 활동 시작 | 인스타 자체운영(비용무)', [
        (' 인플루언서 마케팅 (31명: 6월 15명/7월 8명/8월 8명)', '테스트 후 이후 결정 / 광고코드+현장스케치 영상',
         [0,0,0,0,0,15,8,8,0,0,0,0]),
        (' O2O 에코백 판촉 이벤트 (37개점 × 50개)',            '영상 보고 방문자+매장 구입자 에코백 증정 / 개당 2,500원',
         [0,0,0,0,0,0,9,0,0,0,0,0]),
        (' 이커머스 테스트 (아마존JP / 라쿠텐)',               '소규모 Sponsored 테스트 / 전환 데이터 수집',
         [0,0,0,0,0,0,5,10,10,0,0,0]),
        (' 칼비 후루그라 코스트코 공동 샘플링 협업',            '후루그라 검색→웰라이프 유입 / 레시피 콘텐츠 연계',
         [0,0,0,0,0,20,0,0,15,0,0,0]),
        (' 홈쇼핑/라이브커머스 SA·DA',                        '오픈 시점 집중 광고 / 7월 집행',
    ...
    ('중국', 'cn', '최종목표: 역직구 채널 안정화 + GP Top5 진입 | 화룬강중 신규 800 파이프라인 런칭', [
        ...
        (' 화룬강중 (신규) 런칭 지원',              '800 파이프라인 / 런칭 예산 우선 배정 / 케이코스메몰 축소분 재배분',
         [0,0,0,0,0,10,5,5,0,0,0,0]),
    ]),
    ('대만', 'tw', '최종목표: Medfirst 단일채널 집중 부스팅 | 성수기 7~9월 극대화', [
        (' Medfirst LINE OA + 성수기 디지털 광고',    '여름 건강음료 피크 / LINE 푸시 + FB/IG 타겟광고',
         [0,0,0,0,0,0,20,25,15,0,0,0]),
        (' 약사 교육 키트 + POP물 + 성과 인센티브',   '약사 추천율 제고 / 처방 카드+선반 스티커 전점 설치',
    ...
    ('싱가포르', 'sg', '최종목표: 가디언 입점 매출 확대 + EXACTITUDE 리오더 촉진', [
        (' 가디언 협업 확대 + 입점 지원',          '가디언 83개점 확장 / EXACTITUDE 샘플링+판촉 집중',
    ...
    ('호주', 'au', '최종목표: 대상 호주 채널 안정화 (천호케어 제외 / 비용대비 성장률 없음)', [
        (' 대상 호주 공동 마케팅 지원',  '천호케어 제외 / 대상 호주 직접 채널만 지원',
