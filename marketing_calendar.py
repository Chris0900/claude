...
PLAN = [
    ...
    ('베트남', 'vn', '1차목표: 오프라인 판매량 증대 + CGF GP 구축 | 내년 법인화 핵심국가 | 대표 3개월 1회 현지 직접 방문', [
        ...
        (' CGF 전문성 (의사협회 논문 + KOL/KOC)',   '6월 논문착수 → 7~10월 KOL/KOC 순차 배포',
         [0,0,0,0,0,20,10,10,5,5,0,0]),
        (' 오프라인 엔드매대 + 시음행사',            '윈마트 262개 확장 / 일본 구조 복사 적용',
         [0,0,0,0,0,10,10,10,10,10,10,0]),
        (' 이너샵 VMD + 홍보물 + 온라인',           '8월 오픈 연동 / 매장 VMD+SNS 병행',
         [0,0,0,0,0,0,0,10,10,0,0,0]),
        (' 매장 샘플링 + 온라인 콘텐츠 연계',        '일본 칼비 구조 복사 / 시음→SNS 후기→재구매 루프',
         [0,0,0,0,0,0,10,20,10,0,0,0]),
        (' 라이브커머스 확산 광고',                  '쇼피 라이브 + TikTok Live 연동 / 전환 극대화',
         [0,0,0,0,0,0,10,10,5,5,5,0]),
    ]),
    ('일본', 'jp', '최종목표: 코스트코 데모 행사 효율 향상 + 뉴케어 지속 운영 |  6/5 활동 시작', [
        (' 인플루언서 마케팅 (인스타+광고코드+현장스케치 영상)', '행사 알림+브랜드 노출 / 6월 집중 런칭',
         [0,0,0,0,0,20,15,15,10,15,10,5]),
    ...
    ('대만', 'tw', '최종목표: 음료시장 성수기 집중 + Medfirst GP Top3 달성', [
